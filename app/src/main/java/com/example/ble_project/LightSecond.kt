...
import com.example.ble_project.databinding.LightSecondBinding

class LightSecond : Fragment(){
    private var mBinding: LightSecondBinding?= null
    private val binding get() = mBinding!!
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        mBinding = LightSecondBinding.inflate(inflater,container,false)
